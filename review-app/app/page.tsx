...
export default function Home() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-800 dark:text-gray-200 selection:bg-blue-500/30 flex flex-col justify-between overflow-x-hidden relative">
      {/* Background Glows */}
      ...
      {/* Header */}
      <header className="border-b border-gray-200 dark:border-gray-900 bg-white dark:bg-gray-950/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/login"
              className="flex items-center gap-1.5 px-4 py-2 rounded-full bg-gray-50 dark:bg-gray-900/60 hover:bg-gray-100 dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-800 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-all duration-200"
            >
              Client Login
            </Link>
            <Link
              href="/admin"
              className="flex items-center gap-1.5 px-4 py-2 rounded-full bg-gray-50 dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-800 text-sm font-medium text-gray-900 dark:text-white transition-all duration-200"
            >
              Admin Panel
      ...
      <main className="max-w-5xl mx-auto px-4 pt-20 pb-16 flex-grow flex flex-col items-center text-center space-y-10 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-6 pt-16 w-full text-left">
          {/* Card 1 */}
          <div className="bg-gray-50 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-800/80 rounded-2xl p-6 hover:border-gray-300 dark:hover:border-gray-700/60 transition-all duration-300 backdrop-blur-sm">
          ...
          <div className="bg-gray-50 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-800/80 rounded-2xl p-6 hover:border-gray-300 dark:hover:border-gray-700/60 transition-all duration-300 backdrop-blur-sm">
            ...
            <h3 className="text-gray-900 dark:text-white font-semibold mb-2">Gemini AI Copy-Writer</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
      ...
      {/* Footer */}
      <footer className="border-t border-gray-200 dark:border-gray-900 py-8 bg-white dark:bg-gray-950/40">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-500 dark:text-gray-500">
          <div>
