...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-800 dark:text-gray-200 flex flex-col justify-between overflow-x-hidden relative">
      {/* Background Glows */}
      <div className="absolute top-[-10%] left-[-20%] w-[600px] h-[600px] rounded-full bg-blue-200/20 dark:bg-blue-900/10 blur-[150px] pointer-events-none" />
      <div className="absolute bottom-[20%] right-[-10%] w-[500px] h-[500px] rounded-full bg-sky-200/20 dark:bg-sky-900/10 blur-[120px] pointer-events-none" />
      ...
      <main className="max-w-5xl mx-auto px-4 pt-20 pb-16 flex-grow flex flex-col items-center text-center space-y-10 relative z-10">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-md bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800/50 text-rose-700 dark:text-blue-500 text-xs font-semibold tracking-wide uppercase">
        ...
        <div className="space-y-4 max-w-3xl">
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-gray-900 dark:text-white leading-[1.15]">
            ...
            <span className="bg-gradient-to-r from-blue-500 via-sky-500 to-sky-600 bg-clip-text text-transparent">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full max-w-md">
          <Link
            href="/login"
            className="w-full sm:w-auto px-8 py-3.5 rounded-md bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm transition-all shadow-lg shadow-blue-600/20 hover:shadow-blue-600/30 flex items-center justify-center gap-2"
          >
            Launch Dashboard
        ...
        <div className="grid md:grid-cols-3 gap-6 pt-16 w-full text-left">
          {/* Card 1 */}
          <div className="bg-white dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-md p-6 hover:border-blue-200 dark:hover:border-blue-800/50 transition-all duration-300">
            <div className="w-10 h-10 rounded-md bg-blue-50 dark:bg-blue-600/10 flex items-center justify-center mb-4">
          ...
          {/* Card 2 */}
          <div className="bg-white dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-md p-6 hover:border-sky-200 dark:hover:border-sky-800/50 transition-all duration-300">
            <div className="w-10 h-10 rounded-md bg-sky-50 dark:bg-sky-600/10 flex items-center justify-center mb-4">
